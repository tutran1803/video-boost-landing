              ...
              <div className="hidden md:grid grid-cols-3 gap-8 py-4 w-full mx-auto px-8">
                <div className="text-center space-y-2 md:space-y-4 group animate-fade-in p-4 transition-all duration-300 hover:scale-[1.02]">
                  <div className="w-32 h-20 md:w-40 md:h-32 rounded-lg flex items-center justify-center mx-auto transition-all duration-500 group-hover:scale-110 overflow-hidden">
                    <img src="/lovable-uploads/8fa48d05-5075-4160-90f0-46cde5f3df45.png" alt="Hồ sơ nổi bật" className="w-20 h-20 md:w-36 md:h-36 object-contain animate-icon-blink" />
                  </div>
                ...
                <div className="text-center space-y-2 md:space-y-4 group animate-fade-in p-4 transition-all duration-300 hover:scale-[1.02]" style={{animationDelay: '0.2s'}}>
                  <div className="w-32 h-20 md:w-40 md:h-32 rounded-lg flex items-center justify-center mx-auto transition-all duration-500 group-hover:scale-110 overflow-hidden">
                    <img src="/lovable-uploads/028dd010-ac08-4756-bd66-7c9e898929a9.png" alt="Được đánh giá cao" className="w-20 h-20 md:w-32 md:h-32 object-contain animate-icon-blink" style={{animationDelay: '0.5s'}} />
                  </div>
                ...
                <div className="text-center space-y-2 md:space-y-4 group animate-fade-in p-4 transition-all duration-300 hover:scale-[1.02]" style={{animationDelay: '0.4s'}}>
                  <div className="w-32 h-20 md:w-40 md:h-32 rounded-lg flex items-center justify-center mx-auto transition-all duration-500 group-hover:scale-110 overflow-hidden">
                    <img src="/lovable-uploads/4baa8f27-46e9-43b6-8292-09fca1b23a87.png" alt="Gợi ý công việc" className="w-20 h-20 md:w-32 md:h-32 object-contain animate-icon-blink" style={{animationDelay: '1s'}} />
                  </div>
                  <div className="text-sm md:text-base font-semibold text-foreground whitespace-nowrap">
                  ...
                  <div className="flex gap-4">
                    <div className="flex-[0_0_90%] text-center space-y-3 p-4 group animate-fade-in transition-all duration-300 hover:scale-[1.02]">
                       <div className="w-40 h-24 rounded-lg flex items-center justify-center mx-auto transition-all duration-500 group-hover:scale-110 overflow-hidden">
                         <img src="/lovable-uploads/8fa48d05-5075-4160-90f0-46cde5f3df45.png" alt="Hồ sơ nổi bật" className="w-32 h-32 object-contain animate-icon-blink" />
                       </div>
                    ...
                    <div className="flex-[0_0_90%] text-center space-y-3 p-4 group animate-fade-in transition-all duration-300 hover:scale-[1.02]" style={{animationDelay: '0.2s'}}>
                       <div className="w-40 h-32 rounded-lg flex items-center justify-center mx-auto transition-all duration-500 group-hover:scale-110 overflow-hidden">
                         <img src="/lovable-uploads/028dd010-ac08-4756-bd66-7c9e898929a9.png" alt="Được đánh giá cao" className="w-28 h-28 object-contain animate-icon-blink" style={{animationDelay: '0.5s'}} />
                       </div>
                    ...
                    <div className="flex-[0_0_90%] text-center space-y-3 p-4 group animate-fade-in transition-all duration-300 hover:scale-[1.02]" style={{animationDelay: '0.4s'}}>
                       <div className="w-40 h-32 rounded-lg flex items-center justify-center mx-auto transition-all duration-500 group-hover:scale-110 overflow-hidden">
                          <img src="/lovable-uploads/4baa8f27-46e9-43b6-8292-09fca1b23a87.png" alt="Gợi ý công việc" className="w-28 h-28 object-contain animate-icon-blink" style={{animationDelay: '1s'}} />
                        </div>
                       <div className="text-lg font-semibold text-foreground whitespace-nowrap">

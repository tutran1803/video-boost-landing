...
const Index = () => {
  ...
  const stepsData = [
    ...
    {
      title: 'Bước 2: Chọn "Thử quay"',
      description: "Chọn vào mục quay video và quay video theo hướng dẫn",
      imageUrl: "/lovable-uploads/877c6161-4f39-4a7a-a61b-8a0cd48f2a32.png"
    },
    {
  ...
  return (
    <div className="min-h-screen bg-background" style={{
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden py-1 md:py-2 -mt-0 w-full pb-1 md:pb-2" style={{background: 'linear-gradient(135deg, rgba(255, 186, 0, 0.06), rgba(255, 186, 0, 0.03))'}}>{/* Reduced padding further */}
        <div className="w-full">
          <div className="text-center space-y-2">
            {/* Hero Content */}
            <div className="max-w-7xl mx-auto space-y-4 rounded-2xl p-4 md:p-8 bg-transparent">
              ...
              <div className="hidden md:grid grid-cols-3 gap-8 py-4 w-full mx-auto px-8">
                ...
                <div className="text-center space-y-2 md:space-y-4 group animate-fade-in p-4 transition-all duration-300 hover:scale-[1.02]" style={{animationDelay: '0.2s'}}>
                  <div className="w-32 h-20 md:w-40 md:h-32 rounded-lg flex items-center justify-center mx-auto transition-all duration-500 group-hover:scale-110 overflow-hidden">
                    <img src="/lovable-uploads/ef1c2959-afc4-472a-abd9-60ac11092255-no-bg.png" alt="Được đánh giá cao" className="w-20 h-20 md:w-32 md:h-32 object-contain" />
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-[0_0_90%] text-center space-y-3 p-4 group animate-fade-in transition-all duration-300 hover:scale-[1.02]" style={{animationDelay: '0.2s'}}>
                       <div className="w-40 h-32 rounded-lg flex items-center justify-center mx-auto transition-all duration-500 group-hover:scale-110 overflow-hidden">
                          <img src="/lovable-uploads/ef1c2959-afc4-472a-abd9-60ac11092255-no-bg.png" alt="Được đánh giá cao" className="w-28 h-28 object-contain" />
                        </div>
      ...
      <section id="video-templates" className="pt-1 md:pt-2 pb-4 bg-background">{/* Reduced top padding significantly */}
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            <h2 className="text-2xl lg:text-3xl font-bold text-foreground mb-2">
              Cảm hứng từ những hồ sơ video xuất sắc
            </h2>
            ...
            <TabsContent value="steps" className="space-y-6">
              ...
              <div className="hidden md:grid grid-cols-4 gap-4">
                {stepsData.map((step, index) => (
                  <Card key={index} className="border-0 shadow-md hover:shadow-lg transition-shadow duration-300 flex flex-col">
                    <CardContent className="p-4 flex flex-col h-full">
                      <div className="w-full aspect-[4/3] bg-white rounded-lg overflow-hidden mb-4 border border-gray-200 flex-shrink-0">
                        <img 
                          src={step.imageUrl} 
                          alt={step.title}
                      ...
                      <div className="text-center flex-1 flex flex-col justify-between">
                        <div>
                          <h3 className="text-sm font-semibold text-foreground mb-2 leading-tight">{step.title}</h3>

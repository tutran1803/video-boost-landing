      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-background to-secondary py-2 md:py-4 -mt-2">
        <div className="w-full">
          <div className="text-center space-y-2">
            {/* Hero Content */}
            <div className="max-w-7xl mx-auto space-y-4 border border-white/20 rounded-2xl p-4 md:p-8 bg-white/50">
              ...
              <div className="hidden md:grid grid-cols-3 gap-4 md:gap-6 py-4 max-w-4xl mx-auto">
                <div className="text-center space-y-2 md:space-y-4 group animate-fade-in">
                  <div className="w-28 h-16 md:w-32 md:h-20 bg-primary/10 rounded-lg flex items-center justify-center mx-auto transition-all duration-500 group-hover:scale-110 group-hover:bg-primary/20 group-hover:shadow-lg group-hover:shadow-primary/30 overflow-hidden">
                    <img src="/lovable-uploads/891138ca-b458-4550-9424-1e5dc7f77f51.png" alt="Hồ sơ nổi bật" className="w-full h-full object-cover rounded-lg" />
                  </div>
                ...
                <div className="text-center space-y-2 md:space-y-4 group animate-fade-in" style={{animationDelay: '0.2s'}}>
                  <div className="w-28 h-16 md:w-32 md:h-20 bg-primary/10 rounded-lg flex items-center justify-center mx-auto transition-all duration-500 group-hover:scale-110 group-hover:bg-primary/20 group-hover:shadow-lg group-hover:shadow-primary/30 overflow-hidden">
                    <img src="/lovable-uploads/10f27253-3a43-4642-8e1b-6fc4eae51bc3.png" alt="Được đánh giá cao" className="w-full h-full object-cover rounded-lg" />
                  </div>
                  <div className="text-base md:text-lg font-semibold text-foreground">
                ...
                <div className="text-center space-y-2 md:space-y-4 group animate-fade-in" style={{animationDelay: '0.4s'}}>
                  <div className="w-28 h-16 md:w-32 md:h-20 bg-primary/10 rounded-lg flex items-center justify-center mx-auto transition-all duration-500 group-hover:scale-110 group-hover:bg-primary/20 group-hover:shadow-lg group-hover:shadow-primary/30 overflow-hidden">
                    <img src="/lovable-uploads/8045a03e-2935-4636-841d-2c89349ac7da.png" alt="Gợi ý công việc" className="w-full h-full object-cover rounded-lg" />
                  </div>
                  <div className="text-base md:text-lg font-semibold text-foreground">
              ...
              <div className="md:hidden py-4 max-w-4xl mx-auto">
                <div className="grid grid-cols-1 gap-3">
                  <div className="text-center space-y-2 p-3 bg-white/30 rounded-lg border border-white/20 group animate-fade-in transition-all duration-300 hover:bg-white/50 hover:scale-[1.02]">
                    <div className="w-20 h-12 bg-primary/10 rounded-lg flex items-center justify-center mx-auto transition-all duration-500 group-hover:scale-110 group-hover:bg-primary/20 group-hover:shadow-lg group-hover:shadow-primary/30 overflow-hidden">
                      <img src="/lovable-uploads/891138ca-b458-4550-9424-1e5dc7f77f51.png" alt="Hồ sơ nổi bật" className="w-full h-full object-cover rounded-lg" />
                    </div>
                ...
                {stepsData.map((step, index) => (
                  <Card key={index} className="border-0 shadow-md hover:shadow-lg transition-shadow duration-300">
                    <CardContent className="p-3 space-y-2">
                      <div className="w-full h-40 bg-white rounded-lg overflow-hidden mb-2 border border-gray-200">
                        <img 
                          src={step.imageUrl} 
                          alt={step.title}
                      ...
                      <div key={index} className="flex-[0_0_85%] min-w-0 pl-4">
                        <Card className="border-0 shadow-md">
                          <CardContent className="p-4 space-y-3">
                            <div className="w-full h-40 bg-white rounded-lg overflow-hidden mb-3 border border-gray-200">
                              <img 
                                src={step.imageUrl} 
                                alt={step.title}
                                className="w-full h-full object-contain"
